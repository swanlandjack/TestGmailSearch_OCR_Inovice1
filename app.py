...
"""
        ...
        # Run verification
        verification = verify_invoice(normalized_data)
        
        # Print verification report
        print_verification_report(job_id, normalized_data, verification)
        
        # Store results
        jobs[job_id]["status"] = "done"
        jobs[job_id]["result"] = normalized_data
        ...
        "jobs": [
            {
                ...
                "invoice_number": job_data.get("result", {}).get("invoice_number", "N/A") if job_data.get("result") else "N/A",
                "verification_passed": job_data.get("verification", {}).get("all_checks_passed", False) if job_data.get("verification") else False
            }
